...
public class AtaUseCase {
	...
	public Map<String,Object> execute (Ata ata) throws JsonProcessingException, IOException{
		AdressEntity adress = this.adressService.findByType(AdressType.ATA.toString());
		this.validator.validade(adress);
		return this.translator.translate(this.service.execute(ata, adress.getUrl()));
	}
}
